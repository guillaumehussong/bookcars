...
const strings = new LocalizedStrings({
  fr: {
    ...
    SUPPLIERS_MAP: 'Carte des fournisseurs',
    RECENT_LOCATIONS: 'Lieux récents',
    ...
    FAR: 'Loin',
    VERY_FAR: 'Très loin',
    SELECT_PICKUP: 'Sélectionner comme emplacement de prise en charge',
    DISTANCE_FROM_YOU: 'Distance de votre emplacement',
    DISTANCE_KM: '{0} km de distance',
    DISTANCE_M: '{0} mètres de distance',
  },
  en: {
    BOOKCARS: env.WEBSITE_NAME,
    ...
    FAR: 'Far',
    VERY_FAR: 'Very Far',
    SELECT_PICKUP: 'Select as Pick-up Location',
    DISTANCE_FROM_YOU: 'Distance from Your Location',
    DISTANCE_KM: '{0} km away',
    DISTANCE_M: '{0} meters away',
  },
  es: {
    BOOKCARS: env.WEBSITE_NAME,
    ...
    SUPPLIERS_MAP: 'Mapa de proveedores',
    ...
    FAR: 'Lejos',
    VERY_FAR: 'Muy lejos',
    SELECT_PICKUP: 'Seleccionar como ubicación de recogida',
    DISTANCE_FROM_YOU: 'Distancia desde tu ubicación',
    DISTANCE_KM: '{0} km de distancia',
    DISTANCE_M: '{0} metros de distancia',
  },
})
